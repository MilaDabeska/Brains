...
class TextBlock(models.Model):
    ...
    text_block_fk = models.ForeignKey(Chapter, default=1, on_delete=models.CASCADE)
    date_created = models.DateTimeField(auto_now_add=True)


class YTLink(models.Model):
    link = models.URLField(max_length=200)
    yt_link_fk = models.ForeignKey(Chapter, default=1, on_delete=models.CASCADE)
    date_created = models.DateTimeField(auto_now_add=True)
...
class FileUpload(models.Model):
    ...
    date_created = models.DateTimeField(auto_now_add=True)
    file_fk = models.ForeignKey(Chapter, default=1, on_delete=models.CASCADE)

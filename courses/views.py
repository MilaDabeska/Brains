...
from .forms import AddLinkForm, FileUploadForm, AddTxtForm, EditCourseForm, EditChapterForm, EditYTLinkForm, \
    EditTxtForm, AddChapterForm
from .models import Course, Chapter, TextBlock, FileUpload, YTLink
...
def courses(request):
    ...
    return render(request, "users/courseUser.html", context)
